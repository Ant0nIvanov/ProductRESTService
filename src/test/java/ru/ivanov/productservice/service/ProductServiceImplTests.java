...
public class ProductServiceImplTests {
    ...
    public void givenNoProducts_whenGetAllProducts_thenEmptyListIsReturned() {
        //given
    ...
    @Test
    @DisplayName("Should return list with one product when one exists")
    public void givenOneProduct_whenGetAllProducts_thenReturnListWithOneProductDto() {
        //given
    ...
    public void givenThreeProducts_whenGetAllProducts_thenAllProductDtosAreReturned() {
        //given
    ...
    @Test
    @DisplayName("Test update product with not existent id functionality")
    ...
    @Test
    @DisplayName("Test delete product by existent id functionality")
    ...
    @Test
    @DisplayName("Test delete product by not existent id functionality")
